...
class Lampyridae.Draw
  ...
  ### Set the global blending or compositing operation when drawing
  #
  # @param type [String] Name of the blending operation - see @blendTypes
  ###
  setGlobalBlending: (type = "source-over") => @ctx.globalCompositeOperation = type;
