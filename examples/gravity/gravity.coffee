...
Lampyridae.Particle::enableGlow = true
...
particles.push(new Lampyridae.Particle canvas, options) # Above
options.radius = 5.0; options.y = yMid + 100; options.vx = -2.8; options.vy = 0.0
options.colour = "#A82310"
particles.push(new Lampyridae.Particle canvas, options) # Below
...
particles.push(new Lampyridae.Particle canvas, options) # right
