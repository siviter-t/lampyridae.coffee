...
(function() {
  ...
  Lampyridae.Particle = (function() {
     ...
     * @param v [Number] Radius of the particle
     * @param rgb [String] RGB Colour code of the particle - e.g. "rgb(255, 255, 255)"
     */
    function Particle(canvas1, x1, y1, theta, v1, radius, rgb) {
      this.canvas = canvas1;
      this.x = x1;
      this.y = y1;
      this.theta = theta;
    ...
    Particle.prototype.draw = function() {
      ...
      this.canvas.context.fillStyle = this.rgb;
  ...
  Lampyridae.Bug = (function(superClass) {
    ...
    function Bug(canvas, x, y, t, v, r, c) {
      var h;
      if (!(arguments.length > 0)) {
      ...
      Bug.__super__.constructor.call(this, canvas, x, y, t, v, r, c);
      return;
    }
