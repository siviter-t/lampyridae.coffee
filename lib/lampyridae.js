...
(function() {
  ...
  Lampyridae.Bug = (function() {
    ...
    function Bug(x, y, theta, v, canvas1) {
      ...
      this.RGB = Lampyridae.hslToRgb(randomWavelength, Lampyridae.bugSaturation, Lampyridae.bugLightness);
      this.rgb = "rgb(" + this.RGB[0] + ", " + this.RGB[1] + ", " + this.RGB[2] + ")";
      return;
    }
